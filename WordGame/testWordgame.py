...
def test_is_valid_word(word_list):
    ...
    if not is_valid_word(word, hand, word_list):
        print ("FAILURE: test_is_valid_word().1")
    ...
    if  is_valid_word(word, hand, word_list):
        print ("FAILURE: test_is_valid_word().2")
    ...
    if  not is_valid_word(word, hand, word_list):
        print ("FAILURE: test_is_valid_word().3")
        print ("\tExpected True, but got False for word: '"+ word +"' and hand:", hand)
    ...
    if  is_valid_word(word, hand, word_list):
        print ("FAILURE: test_is_valid_word().4")
        print ("\tExpected False, but got True for word: '" + word + "' and hand:", hand)
    ...
    if  not is_valid_word(word, hand, word_list):
        print ("FAILURE: test_is_valid_word().5")
        print ("\tExpected True, but got False for word: '" + word + "' and hand:", hand)
    ...
    if  is_valid_word(word, hand, word_list):
        print ("FAILURE: test_is_valid_word().6")
        print ("\tExpected False, but got True for word: '" + word + "' and hand:", hand)
